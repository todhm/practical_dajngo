...
class ReportingColoredAdminSite(ColoredAdminSite):
    ...
    def index(self,request,extra_context=None):
        ...
        if not extra_context: 
            extra_context = {}
            extra_context = {
                "reporting_pages":reporting_pages
            }
...
class InvoiceMixin: 
    ...
    def invoice_for_order(self,request,order_id):
        ...
        if request.GET.get("format") == "pdf":
            ...
            response['Content-Dispoistion'] = "inline;filename=invoice.pdf"
...
class OwnerAdminSite(InvoiceMixin,ReportingColoredAdminSite):
